...
class Scoreboard:
    ...
    def prep_score(self):
        ...
        score_str = f"{rounded_score:,}" #the :, is a way to format the number to have commas, like 1,000 vs 1000
    ...
    def show_score(self):
        '''
        Draw the scores, level, & ships to the screen
        '''
